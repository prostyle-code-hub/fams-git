...
class Login extends CI_Controller {
    ...
    public function activate_agent() {
        ...
        $this->crud_model->activate_user($param1);
...
//    public function validate_agents($param1 = "") {
//        echo $param1;
//
//        $this->crud_model->activate_user($param1);
//        $page_data['page_name'] = 'activate';
//        $page_data['page_title'] = site_phrase('forgot_password');
//        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
//    }
...
//        }
        ...
        if ($query->num_rows() > 0) {
            ...
            //echo get_user_role('user_role', $row->id); exit();
            $this->session->set_userdata('role', get_user_role('user_role', $row->id));
            $this->session->set_userdata('roleme', get_user_role('user_role', $row->id));
            $this->session->set_userdata('name', $row->first_name . ' ' . $row->last_name);
            $this->session->set_userdata('join_date', $row->date_added);
...
//        }
        ...
        //$this->session->set_userdata($your_name);
        //echo "User Name";
    ...
    function change_password_new() {
        ...
        $verification_code = $this->input->post('reset_code');
        $password = $this->input->post('password');
        $new_password = $this->input->post('new_password');

        //$decoded_verification_code = $verification_code;
        ...
        if ($verification_code != "") {
            ...
            if ($row->num_rows() <= 0) {
                $this->session->set_flashdata('flash_message', get_phrase('invalid code'));
                redirect(site_url('home/verification_code_exp/' . $verification_code), 'refresh');
            }
