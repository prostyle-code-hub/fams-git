...
class Home extends CI_Controller
{
    ...
    public function verification_code($param1="")
    {
...
//        }
        $page_data['reset_code'] = $param1;
        $page_data['page_name'] = "verification_code";
        $page_data['page_title'] = site_phrase('verification_code');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    
    public function verification_code_exp()
    {
//        if (!$this->session->userdata('register_email')) {
//            redirect(site_url('home/sign_up'), 'refresh');
//        }
        $page_data['page_name'] = "verification_code_exp";
        $page_data['page_title'] = site_phrase('verification_code');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    ...
    public function validate_agent($param1 = "")
    {        
