                                        ...
                                        <td class="content-cell">
                                            <div class="f-fallback">
                                              ...
                                              <hr style="border: 1px solid #fff; margin-bottom: 10px;">
												<h2>おめでとう! </h2>
                                              <h5 >拝啓 <?= $to_name; ?>,</h5>
												<p>外国人申請者管理システムに国内ユーザーアカウントが作成されたことをお知らせいたします。 ポータルにアクセスするには、以下のデフォルトのログイン資格情報を使用してログインしてください。
												</p>
												<ul>
													<li>URL: <a href="<?= base_url('login/'); ?>">ログイン</a> </li>
													<li>ユーザーEメール: <?= $to; ?></li>
													<li>デフォルトパスワード: <?= $verification_code; ?></li>
...
<br>
											  <center><small> これはシステムによって生成されたEメールです。人間によるやり取りはありませんので、返信しないでください。 <br>&copy; FAMS。無断複写・転載を禁じます。 </small></center>
                                            </div>
                                        </td>
                                    </tr>
                                 </table>
