<span style="background-color: #5949fe;color: #ffffff;font-size: x-small;">UI No: FAMS5300 | Applicant Registration</span> <!-- UI Number -->
                ...
                <div class="card-body">
                    <div id="account-details" class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-check ">
                                <input type="number" id="romaji_fname" name="contact_ap_fixed" class="form-control mandatory" required onkeydown="limitText(this, 9);" />
                            </div>
                            <div class="col-md-2"><?= get_phrase('contact_ap_mobile') ?>:
                            </div>
                            <div class="col-md-4 form-check ">
                                <input type="number" id="romajii_lname"  name="contact_ap_mobile" class="form-control" onkeydown="limitText(this, 9);" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-check ">
                                <input type="number" id="romajii_lname"  name="contact_ap_fax" class="form-control" onkeydown="limitText(this, 9);"/>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div id="account-details" class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-check ">
                                <input type="number" id="kanji_fname" name="sponsor_contact_sp_fixed" class="form-control" onkeydown="limitText(this, 9);" />
                            </div>
                            <div class="col-md-2"><?= get_phrase('contact (sp_mobile)') ?>:
                            </div>
                            <div class="col-md-4 form-check ">
                                <input type="number" id="kanji_fname"  name="sponsor_contact_sp_mobile" class="form-control" onkeydown="limitText(this, 9);" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-check ">
                                <input type="number" id="kanji_lname"  name="sponsor_contact_sp_w_fixed" class="form-control" onkeydown="limitText(this, 9);"/>
                            </div>
                            <div class="col-md-6">
