<span style="background-color: #5949fe;color: #ffffff;font-size: x-small;">UI No: FAMS1100 | Domestic User Dashboard</span> <!-- UI Number -->
                        ...
                        <div class="row gy-6">
                            <div class="col-md-6 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0"><?php echo $widget_reg_applicants; ?></h5>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0"><?php echo $widget_req_applicants; ?></h5>
                                        <small style="font-size: x-small;">
                            ...
                            <div class="col-md-6 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0"><?php echo $widget_app_not_completed; ?></h5>
                                        <small style="font-size: x-small;">
                            ...
                            <div class="col-md-6 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0"><?php echo $widget_app_completed; ?></h5>
                                        <small style="font-size: x-small;">
