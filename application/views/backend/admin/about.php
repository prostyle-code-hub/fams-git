            ...
            <div class="media-body">
              <div class="chart-widget-list">
                ...
                <p style="margin-top: 8px;">
                  ...
                  <?php if($application_details['product_license'] !== 'CodeCup'): ?>
                    <span class="float-right badge badge-success-lighten">valid</span>
                  <?php else: ?>
                    <span class="float-right badge badge-danger-lighten mt-1">valid</span>
                ...
                <p>
                  ...
                  <span class="float-right">
                    ...
                    <?php elseif (strtolower($application_details['purchase_code_status']) == 'valid'): ?>
                      <span class="badge badge-success-lighten">valid</span>
                    <?php else: ?>
                ...
                <p>
                  <i class="mdi mdi-square"></i> <?php echo get_phrase('support_expiry_date'); ?>
                    ...
                    <?php if ($application_details['support_expiry_date'] != "valid"): ?>
                ...
                <p class="mb-0">
                  ...
                  <?php if ($application_details['customer_name'] != "valid"): ?>
                      <span class="float-right">Madhushan Fonseka</span>
                  <?php else: ?>
                ...
                <p style="margin-top: 8px;">
                  ...
                  <span class="float-right"><a href="https://codecup.co" target="_blank" style="color: #343a40;"> <i class="mdi mdi-telegram"></i> <?php echo get_phrase('customer_support'); ?> </a> </span>
                </p>
              </div>
            </div>
