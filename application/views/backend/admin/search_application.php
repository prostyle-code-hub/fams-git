<span style="background-color: #5949fe;color: #ffffff;font-size: x-small;">UI No: FAMS7300 | Search Application Form (Agent View)</span> <!-- UI Number -->
<script type="text/javascript">
    document.getElementById('application_page').style = 'background-color: #7467f0;color: white;';
</script>
<div class="container-xxl flex-grow-1 container-p-y">
    <form action="<?php echo site_url('user/search_application/search'); ?>" method="post">
        <div class="row">
            <div class="col-md-8">
            ...
            <div class="col-md-4" style="text-align: right;">
                ...
                <div class="btn-group" role="group" aria-label="Button Set">
                    <a href="<?php echo base_url('user/search_application/') ?>" class="btn btn-secondary waves-effect waves-light"><?= get_phrase('Reset') ?></a>
                ...
                <div id="account-details" class="content">
                    ...
                    <div id="collapseDeliveryAddress" class="accordion-collapse collapse show" data-bs-parent="#collapsibleSection" style="">
                        <div class="accordion-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-2"><?= get_phrase('Applicant last name') ?>:<br>
                                ...
                                <div class="col-md-4 form-check">
                                    <input type="text" class="ms-1 form-control form-input1 " aria-label="first_name" id="kanji_lname" name="first_name" <?php if ($this->session->userdata('student_fn') != '') { ?> value='<?php echo $this->session->userdata('student_fn') ?>' <?php } ?>>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4 form-check ">
                                    <select name="application_status" id="citizenship" class="ms-1 form-control form-input1 dropdown-toggl  dropdown-toggle waves-effect waves-light">
                                        ...
                                        ?>><?= get_phrase('Waiting for Correction') ?></option>
                                        <option value="4" <?php
                                        ...
                                        ?>><?= get_phrase('submitted_to_imigration') ?></option>
                                        <option value="6" <?php
