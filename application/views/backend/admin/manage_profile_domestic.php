<span style="background-color: #5949fe;color: #ffffff;font-size: x-small;">UI No: FAMS6000 | My Profile (Domestic User)</span> <!-- UI Number -->
<!-- Content -->
                        ...
                        <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
                            <div class="user-profile-info">
                                ...
                                <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                    ...
                                    <?= get_phrase('domestic_user') ?>
                                      </li>

                                    <li class="list-inline-item"><i class="ti ti-calendar"></i><?= get_phrase('Registered at') ?> <?php echo date('d M Y', $this->session->userdata('join_date')); ?></li>
                                </ul>
                            </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-check"></i><span class="fw-bold mx-2"><?= get_phrase('status') ?>:</span> <span><?= get_phrase('Active') ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-crown"></i><span class="fw-bold mx-2"><?= get_phrase('role') ?>:</span> <span> <?= get_phrase('domestic_user') ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-flag"></i><span class="fw-bold mx-2"><?= get_phrase('country') ?>:</span> <span><?= get_phrase('Japan') ?></span>
                        </li>
