<span style="background-color: #5949fe;color: #ffffff;font-size: x-small;">UI No: FAMS5410 | Applicant Basic Information view </span> <!-- UI Number -->
<style>
    .answer {
        ...
        <div class="col-md-9" style="text-align: right">
            <?php foreach ($students->result_array() as $key => $student) : ?>
                <div class="btn-group" role="group" aria-label="Button Set">
                    ...
                    <a type="button" class="btn btn-secondary waves-effect waves-light green" href="/user/student/add"><?= get_phrase('Add New Student') ?></a>
                    <?php if ($student['application'] == '0') { ?>
                        <a href="<?php echo site_url('user/student_application/create/' . $student['id']); ?>" type="button" class="btn btn-primary btnsuccess waves-effect waves-light"><?= get_phrase('Create Application') ?></a>
                    <?php } else { ?>
                        <a href="<?php echo site_url('user/student_application/view/' . $student['id']); ?>" type="button" class="btn btn-secondary btnsuccess waves-effect waves-light"><?= get_phrase('View Application') ?></a>
                    <?php } ?>

                    <a href="javascript:;" data-bs-target="#deleteStudent<?php echo $student['id']; ?>" data-bs-toggle="modal" class="btn btn-secondary btnremove waves-effect waves-light red"><?= get_phrase('Delete') ?></a>
                    <a type="button" class="btn btn-secondary waves-effect waves-light blue" href="/user/student/edit/<?php echo $student['id'] ?>"><?= get_phrase('Modify') ?></a>
                    ...
                    <div class="card-body">
                        <div id="account-details" class="content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 answer"> <?php echo $student['passport_create'] ?>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4 answer"> <?php echo $student['future_plan'] ?>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div id="account-details" class="content">
                            ...
                            if(($student['fr_1'] == "") && ($student['fr_2'] == "") && ($student['fr_3'] == "") &&($student['fr_4'] == "") &&($student['fr_5']=="") &&($student['fr_6']=="")) { ?>
                                <?php //if ($student['fr_5'] != "") { ?>
                                <div class="row">
                                    <div class="col-md-2"> <?= get_phrase('Relationship') ?>: </div>
                                    <div class="col-md-4 answer"></div>
                                    <div class="col-md-2"><?= get_phrase('First name and last name') ?>: </div>
                                    <div class="col-md-4 answer"> </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2"> <?= get_phrase('Date of birth') ?>:
                                    ...
                                    <div class="col-md-4 answer"> </div>
                                    <div class="col-md-2"><?= get_phrase('Profession') ?>: </div>
                                    <div class="col-md-4 answer"></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2"> <?= get_phrase('Current address') ?>:
                                    ...
                                    <div class="col-md-4 answer"> </div>
                                    <div class="col-md-2"><?= get_phrase('Life and death') ?>: </div>
                                    <div class="col-md-4 answer"> </div>
                                </div>
                                <br/>
                            <?php } ?>
