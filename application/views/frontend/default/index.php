...
<html lang="en">
    <head>
        ...
        if ($page_name == 'course_page'):
            $title = "FAMS"//$this->crud_model->get_course_by_id($course_id)->row_array()
            ?>
            <title><?php echo "FAMS" //$title['title'] . ' | ' . get_settings('system_name'); ?></title>
        <?php else: ?>
            <title><?php echo "FAMS" //ucwords($page_title) . ' | ' . get_settings('system_name'); ?></title>
        <?php endif; ?>
        ...
        if (in_array($page_name, $seo_pages)):
            ...
            ?>
            <meta name="keywords" content="FAMS<?php //echo $course_details['meta_keywords']; ?>"/>
            <meta name="description" content="FAMS<?php //echo $course_details['meta_description']; ?>" />
        ...
        <?php if ($page_name == "course_page"): ?>
            <meta property="og:title" content="<?php echo "FAMS"//$title['title']; ?>" />
            <meta property="og:image" content="<?php echo $this->crud_model->get_course_thumbnail_url($course_id); ?>">
        <?php elseif ($page_name == 'blog_details'): ?>
            <meta property="og:title" content="<?php echo "FAMS"//$blog_details['title']; ?>" />
        ...
        <?php else: ?>
            <meta property="og:title" content="<?php echo "FAMS" //$page_title; ?>" />
