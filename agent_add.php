                        ...
                        <div id="account-details" class="content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" id="email" name="email" class="form-control mandatory" placeholder="" required onfocusout="myFunction()"/>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" id="romajii_lname" name="skype" class="form-control" placeholder="<?php echo get_phrase('Skype ID'); ?>" />
                                </div>
